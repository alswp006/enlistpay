...
### Module Dependencies (import graph)
  pages/NotFound.tsx → imports: components/ScreenScaffold
...
- 0018: 라우터 배선 + 전역 Provider + 탭바 + NotFound (files: src/App.tsx, src/pages/NotFound.tsx, src/components/ErrorBoundary.tsx)
- 0019: 배너 슬롯 래퍼 · 햅틱 헬퍼 · 검수 정책 정적 스캔 (files: src/components/AdFooterSlot.tsx, src/hooks/useHaptic.ts, scripts/policy-scan.mjs)
- heal-1-02: 배너 슬롯 래퍼 · 햅틱 헬퍼 · 자기검출 없는 정책 스캔 (0019 재작성) (files: src/components/AdFooterSlot.tsx, src/hooks/useHaptic.ts, scripts/policy-scan.mjs, package.json)
...
// src/components/CalcDisclaimer.tsx
